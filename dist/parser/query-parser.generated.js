...
function peg$parse(input, options) {
    ...
    function peg$f1(target, calls) { return expression(target, calls); }
    function peg$f2(method, args) {
        return { type: "Call", method, arguments: args || [] };
    }
    function peg$f3(head, tail) { return [head, ...tail.map(item => item[3])]; }
    function peg$f4(values) { return values || []; }
    function peg$f5(value) { return JSON.parse(value); }
    function peg$f6(escaped) { return escaped; }
    function peg$f7(chars) { return chars.join(""); }
    function peg$f8(value) { return Number(value); }
...
//# sourceMappingURL=query-parser.generated.js.map