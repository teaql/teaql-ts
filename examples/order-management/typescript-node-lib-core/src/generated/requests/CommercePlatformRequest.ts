...
import { CommercePlatform } from '../models/CommercePlatform';



export class CommercePlatformRequest {
    ...
    constructor() {
        this.query = new SelectQuery("CommercePlatform");
    }
    ...
    purpose(p: string): ExecutableCommercePlatformRequest {
    ...
    selectCustomerListWith(request: { toQuery(): SelectQuery }): this {
        this.query.relationQuery("customerList", request.toQuery());
        return this;
    }
    selectOrderStatusListWith(request: { toQuery(): SelectQuery }): this {
        this.query.relationQuery("orderStatusList", request.toQuery());
        return this;
    }
    ...
    selectProductListWith(request: { toQuery(): SelectQuery }): this {
        this.query.relationQuery("productList", request.toQuery());
        return this;
    }
    ...
    selectOrderSearchPresetListWith(request: { toQuery(): SelectQuery }): this {
        this.query.relationQuery("orderSearchPresetList", request.toQuery());
        return this;
    }
...
export class ExecutableCommercePlatformRequest {
    constructor(
        private readonly execute: (ctx: UserContext) => Promise<any>,
        private readonly limitOne: () => void,
    ) {}

    newEntity(ctx: UserContext): CommercePlatform {
        return new CommercePlatform();
    }
